...
def payment_success(request, order_id):
    ...
    # Fixed: Added check to prevent duplicate processing if payment already completed
    if order.paid:
        messages.info(request, 'This payment has already been processed.')
        return render(request, 'shop/payment_success.html', {'order' : order})
    
    # Mark order as paid and set status to processing
    order.paid = True 
    ...
    # Fixed: Clear session after successful payment to prevent re-processing
